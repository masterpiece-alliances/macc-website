    ...
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {services.map((service) => (
              <div key={service.id} className="bg-white p-6 md:p-8 rounded-lg shadow-md hover:shadow-lg transition">
      ...
      <section className="py-12 md:py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href="/contact" className="bg-white text-blue-600 px-6 md:px-8 py-3 rounded-lg font-semibold text-lg hover:bg-gray-100 transition">
            무료 상담 신청
          </Link>
        </div>
      </section>
