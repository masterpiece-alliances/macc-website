    ...
    <div className="flex flex-col">
      ...
      <div className="container mx-auto px-4 py-8 md:py-16">
        ...
        <div className="max-w-3xl mx-auto mb-8 md:mb-16 text-center">
          ...
          <div className="flex flex-row flex-wrap justify-center space-x-3 space-y-0 mt-6 md:mt-8">
            <div className="flex items-center justify-center text-blue-600 ml-3 mt-3 md:mt-0">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>맞춤형 솔루션</span>
            </div>
            <div className="flex items-center justify-center text-blue-600 mt-3 md:mt-0">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <span>전문가 코칭</span>
